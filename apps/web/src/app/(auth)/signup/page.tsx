    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <Link href="/login" className="mt-8 inline-block text-sm text-blue-400 hover:text-blue-300 transition-colors">← Back to sign in</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] xl:w-[55%] flex-col justify-between p-12 xl:p-16 relative overflow-hidden"
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center py-12">
          <div className="mb-3 inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold text-indigo-400 w-fit"
