...
export default function InboxesClient({ planId = "free", maxInboxes = 5 }: InboxesClientProps) {
  ...
  return (
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {/* Trial expired panel removed — trial program discontinued. */}

      {/* Free plan — inbox count indicator */}
      {planId === "free" && maxInboxes > 0 && (
        inboxes.length > maxInboxes ? (
          <div className="mb-4 bg-amber-500/8 border border-amber-500/25 rounded-lg px-3 py-2 flex items-center gap-2 text-xs">
            ...
            <span className="text-amber-300 font-medium">You have {inboxes.length} inboxes but your Free plan allows {maxInboxes}.</span>
            <span className="text-white/40">No new inboxes can be added until you <Link href="/settings?tab=billing" className="text-amber-400 underline">upgrade</Link>.</span>
          </div>
        ) : (
