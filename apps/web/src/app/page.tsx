...
function Pricing() {
  const plans = [
    ...
    },
    {
      ...
      features: ["25,000 lead credits/month", "15 sending inboxes", "Unlimited sequences", "Inbox warmup", "Advanced AI (deep mode)", "A/B testing", "CRM pipeline", "Priority support"],
      cta: "Start free trial",
      highlight: true,
      badge: "Most popular",
    },
    {
      ...
      features: ["100,000 lead credits/month", "Unlimited inboxes", "Unlimited sequences", "Everything in Growth", "Multiple workspaces", "White-label ready", "Dedicated Slack support", "Custom onboarding"],
      cta: "Talk to sales",
      highlight: false,
    },
  ];
