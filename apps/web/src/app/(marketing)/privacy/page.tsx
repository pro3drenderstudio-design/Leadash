      ...
      <div className="mb-14">
        ...
        <div className="mt-6 p-4 rounded-xl" style={{ background: "rgba(249,115,22,0.06)", border: "1px solid rgba(249,115,22,0.2)" }}>
          <p className="text-orange-300/70 text-sm leading-relaxed">
            This Privacy Policy explains how Leadash (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) collects, uses, and protects your personal
            information when you use our platform. We are committed to handling your data transparently.
          </p>
        </div>
      </div>
